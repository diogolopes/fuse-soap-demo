 ...
 * 2020-07-06T20:02:11.334-03:00
 * Generated source version: 3.2.5-jbossorg-1
 *
 */
@WebServiceClient(name = "ISoapWhoisServiceService",
                  wsdlLocation = "file:/home/rosantos/workspace-jb421/fuse-cxf-demo/src/main/resources/wsdl/whois.wsdl",
...
public class ISoapWhoisServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/rosantos/workspace-jb421/fuse-cxf-demo/src/main/resources/wsdl/whois.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ISoapWhoisServiceService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/rosantos/workspace-jb421/fuse-cxf-demo/src/main/resources/wsdl/whois.wsdl");
        }
        WSDL_LOCATION = url;
    }
